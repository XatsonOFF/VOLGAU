        ...
        <div class="col-md-10 mx-auto" style="background-color: white;min-height:20rem;">
            <div class="col-md-5 mx-auto">
                <div class="text-center">
                    <h3 class="mb-5"><b>Регистрация</b></h3>
                    <?php
                    ...
                    ?>
                        <form action="signup.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="birthday_date" id="birthday_date" class="form-control" max="2023-04-23" value="<?php if(isset($_POST['birthday_date'])){ echo $_POST['birthday_date'];}?>">
                            </div>
                            <div class="form-group">
                                <label for="address">Адрес</label>
                                <input type="text" name="address" id="address" class="form-control" placeholder="г.Волгоград, просп. Университетский, 26" value="<?php if(isset($_POST['address'])){ echo $_POST['address'];}?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="interests" id="interests" class="form-control" placeholder="Люблю спать" value="<?php if(isset($_POST['interests'])){ echo $_POST['interests'];}?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" name="vk" id="vk" class="form-control" placeholder="https://vk.com/id" value="<?php if(isset($_POST['vk'])){ echo $_POST['vk'];}?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <p class="text-center mt-3">Уже есть аккаунт?<br><a href="index.php">Войти в аккаунт</a></p>
                            </div>
                        </form>
                        <?php
                        }else{
